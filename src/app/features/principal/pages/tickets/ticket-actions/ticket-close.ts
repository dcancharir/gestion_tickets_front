            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                                ...
                                <div class="pure-card rounded-custom card-bg shadow-custom">
                                    ...
                                    <div class="pure-card-body">
                                        ...
                                        <div class="row row-cols-1 gy-5">
                                            <div class="col">
                                                <label for="" class="form-label">Comentario <span class="text-danger fw-bold">*</span></label>
                                                <textarea class="form-control" [(ngModel)]="comentario" placeholder="Ingrese Descripcion"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" (click)="asignar()">Cerrar Ticket</button>
                    </div>
                </div>
            </div>
        </div>
...
export class TicketClose{
    ...
    asignar(){
        ...
        if(!comentario ){
            this.toast.show('Ingrese un comentario','error')
            return
        }
        ...
        this.incidenciaService.cerrarTicket(incidenciaPublicId,comentario).subscribe({
            next:(result)=>{
                if(result){
                    this.toast.show('Se cerro el ticket','success')
                    this.asignado.emit()
                }
            },
            error:(err)=>{
